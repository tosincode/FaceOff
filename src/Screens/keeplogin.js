...
function Login({ navigation }) {
  ...
  const [callLogin] = useMutation(LOGIN_MUTATION,{
    ...
    onCompleted(data) {
      if (data) {
        ...
        navigation.navigate('passcode',{number:'+1'+form.phone, maskedPhone:maskedPhone});
      }
    },
  ...
  return (
    <View style={Styles.Container}>
      <KeyboardAwareScrollView contentContainerStyle={{flexGrow:1, alignItems: 'flex-end'}} scrollEnabled={true} extraHeight={100} enableOnAndroid={true} bounce={false}>
        ...
        <View style={{flex:1, justifyContent: 'flex-end'}} >
          <View style={{backgroundColor:'#f4f6f8', padding:20, paddingHorizontal:40 }}>
          <BoldText style={{ color: '#000', fontSize: 28, textAlign:'center', marginBottom:20 }}>Login</BoldText>
          ...
          <TextInputMask
            ...
            style={{ color: '#2a6b9c', fontSize: 15, borderWidth: 1, borderColor: "#C0C0C0", borderRadius: 25, paddingHorizontal: 30, minHeight: 45 }}
